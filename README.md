# nvim-treesitter-queries-bicep

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-bicep/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-bicep/actions/workflows/validate.yml)

Neovim tree-sitter queries for **bicep**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-bicep",
...
- [ ] Changes are scoped to `bicep` — do not include files for other languages
